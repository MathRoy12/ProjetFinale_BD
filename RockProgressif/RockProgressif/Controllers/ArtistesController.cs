...
namespace RockProgressif.Controllers
{
    public class ArtistesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ArtisteId,NomScene,NomComplet,DateNaissance")] Artiste artiste)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ArtisteId,NomScene,NomComplet,DateNaissance")] Artiste artiste)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProgRockBDContext.Artistes'  is null.");
            }
            var artiste = await _context.Artistes.FindAsync(id);
            if (artiste != null)
            {
