...
namespace RockProgressif.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlbumId,Nom,DatePublication,NombreVentes,NoteCritiques,GroupeId")] Album album)
        {
            ...
            ViewData["GroupeId"] = new SelectList(_context.Groupes, "GroupeId", "GroupeId", album.GroupeId);
            return View(album);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlbumId,Nom,DatePublication,NombreVentes,NoteCritiques,GroupeId")] Album album)
        {
            if (id != album.AlbumId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProgRockBDContext.Albums'  is null.");
            }
            var album = await _context.Albums.FindAsync(id);
            if (album != null)
            {
